...
利用开源AI视觉大模型（smolVLM2）与 MediaPipe 库，多种混合检测模式进行实时检测所有<strong>类人生物</strong>的活动，守护你的安全

 当程序内摄像头检测到人形智慧生物，如 <strong> 人类 / 兽人 / 哥布林 / 精灵 / 半身人 / 虎人 / 夺心魔 / 魅魔</strong> 出现时，自动`最小化指定的程序窗口`。
